...
#[Route('/chan/spa')]
class ChanSpaController extends AbstractController
{
    ...
    #[Route('/', name: 'chan_all_spa')]
    public function allSpa(): Response
    {

        return $this->render('chan_spa/spa/all.html.twig', [
            'active' => 'spa_create',
            'unites' => $this->getDoctrine()->getManager()->getRepository(Unite::class)->findAll(),
            'spas' => $this->getDoctrine()->getManager()->getRepository(Spa::class)->findAll(),
        ]);
    }


    #[Route('/show-spa/{spa}', name: 'chan_spa_show')]
    public function showSpa(Spa $spa): Response
    {

        return $this->render('chan_spa/spa/show.html.twig', [
            'spa' => $spa,
            'active' => "spa_create",
        ]);
    ...
    public function index(Request $request): Response
    {
        ...
        return $this->render('chan_spa/stat/index.html.twig', [
